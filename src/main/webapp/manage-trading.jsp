	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Manage Trading</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					%>
					<div class="alert alert-success" id="success">Trading updated
						successfully.</div>
					<%
						}
					%>
					...
					<div class="panel panel-default">
						<div class="panel-heading">Manage Trading</div>
						<div class="panel-body">
							<div class="form-row">
								<form action="manage-trading.jsp" method="post">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										try {
											...
											"select * from client_details natural join trade_details where client_name='" + clientName + "' ");
											while (rs.next()) {
										%>
										<tr class="odd gradeX">
											<td><%=rs.getInt(8)%></td>
											...
											<td class="center"><a
												href="edit-trading.jsp?tid=<%=rs.getInt(8)%>"><button
