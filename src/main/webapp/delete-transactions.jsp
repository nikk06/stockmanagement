	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Delete Transactions</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Delete Transactions</div>
						<div class="panel-body">
							<div class="form-row">
								<form action="delete-transactions.jsp" method="post">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="center"><a
												href="delete-transactions-process.jsp?del=<%=rs.getInt(8)%>"
												onclick="return confirm('Are you sure you want to delete?');"" >
													<button class="btn btn-danger">
														<i class="fa fa-pencil"></i> Delete Transaction
													</button></td>
										</tr>
										<%
											}
