...
<html lang="en">
<head>
<title>Stocks Market Trade Watch</title>
	...
	<header>
		<div class="container agile-banner_nav">
			<div class="row header-top">
				<div class="col-md-5 top-left p-0">
					<p>
						...
						91-8102190197 / 8969002264 / 8839618766
					</p>
				</div>
				<div class="col-md-7 top-right p-0">
					<p>
						<i class="fa fa-map-marker" aria-hidden="true"></i> Stocks Market
						Trade Watch.</p>
				</div>
			</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h3>
					<a class="navbar-brand" href="index.jsp">Trade Watch</a>
				</h3>
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item pr-0 active"><a class="nav-link pr-lg-0"
							href="contact.jsp">Contact</a></li>
						<li class="nav-item pr-lg-0"><a class="nav-link pr-lg-0"
							href="userLogin.jsp">Client Login</a></li>
						<li class="nav-item pr-lg-0"><a class="nav-link pr-lg-0"
				...
				<div class="col-lg-5 col-md-6 agileits_w3layouts_contact_gridl">
					<div class="agileits_mail_grid_right_grid">
						...
						<ul class="contact_info">
							<li><span class="fa fa-map-marker" aria-hidden="true"></span>Stocks
								Market Trade Watch</li>
							<li><span class="fa fa-envelope" aria-hidden="true"></span><a
								href="">nitinsr246@gmail.com</a></li>
	...
	<footer class="py-5">
		<div class="container py-md-3">
			<div class="row footer-grids pb-md-5 pb-3">
				...
				<div class="col-md-6 col-sm-6 col-6">
					<a href="#"> <i class="fa fa-envelope"></i>Send Message
					</a>
				</div>
			</div>
