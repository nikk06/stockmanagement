				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							<%
								try {
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from admin where uname='" + session.getAttribute("uname") + "'");
								if (resultset.next()) {
							%>
							...
							<div class="form-group">
								<label>My User Name</label> <input class="form-control"
