	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Delete Client Logo</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<%
						String logoDelete = (String) session.getAttribute("message");
					if (logoDelete != null) {
					...
					<div class="panel panel-default">
						<div class="panel-heading">Delete Client Logo</div>
						<div class="panel-body">
							<div class="form-row">
								<form action="delete-logo.jsp" method="post">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td><image src="uploads/<%=rs.getString(8)%>" width="60"
													height="70"></image></td>
											<td class="center"><a
												href="delete-logo-process.jsp?cid=<%=rs.getInt(1)%>"><button
														class="btn btn-danger">
														<i class="fa fa-edit "></i> Delete Logo
													</button></td>
										</tr>
										<%
											}
