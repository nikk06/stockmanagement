		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"> <img
					src="assets/img/logo.jpeg" style="width: 150px; height: 60px;" />
				</a>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="admin/assets/img/admin-login-logo.jpg"
						class="img-thumbnail" alt="Cinque Terre" style="width:504px;height:280px;">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<%
