				...
				<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							try {
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from admin_config where admin_id='" + aid + "'");
								while (resultset.next()) {
							%>
							<form role="form" method="post" action="ModifyAdminLogo"
								enctype="multipart/form-data">
								<div class="form-group">
									<label>Admin Id</label> <input class="form-control" type="text"
										name="tid" value="<%=resultset.getInt(1)%>" readonly />
								</div>
								<div class="form-group">
									<label>Admin User Name</label> <input class="form-control"
										type="text" name="tlimit" value="<%=resultset.getString(2)%>"
										readonly />
								</div>
								<div class="form-group">
									<label>Logo</label>
									<image src="uploads/<%=resultset.getString(3)%>" width="60"
										height="70"></image>
								</div>
								<div class="form-group">
