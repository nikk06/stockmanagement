	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Delete Admin Logo</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					%>
					<div class="alert alert-success" id="success">Logo deleted
						successfully.</div>
					<%
						}
					%>
					<div class="panel panel-default">
						<div class="panel-heading">Delete Admin Logo</div>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										<%
											try {
											ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from admin_config ");
										...
										<tr class="odd gradeX">
											...
											<td><image src="uploads/<%=resultset.getString(3)%>"
													width="60" height="70"></image></td>
											<td class="center"><a href="delete-admin-logo.jsp?aid=<%=resultset.getInt(1)%>"
